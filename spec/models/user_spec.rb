...
describe User do
  ...
  it "should reject duplicate email addresses irrespective of case" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email addres with no user" do
        User.authenticate("unknown@user.com", @attr[:password]).should be_nil
      end
  ...
  describe "micropost associations" do
     ...
     describe "status feed" do
       ...
       it "should include the user's microposts" do
         @user.feed.should include(@first_micropost)
         @user.feed.should include(@first_micropost)
       end
       
       it "should not include a different user's micropost" do
         third_micropost = Factory(:micropost, 
